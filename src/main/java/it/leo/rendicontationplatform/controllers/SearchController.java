...
public class SearchController {
    ...
    public ResponseEntity getAdvancedSearchServices(@RequestParam(value = "title") String title, @RequestParam(value = "startDate") Date startDate, @RequestParam(value = "endDate") Date endDate, @RequestParam(value = "quantityParticipants") int quantityParticipants, @RequestParam(value = "impact") int impact, @RequestParam(value = "duration") int duration, @RequestParam(value = "otherAssociations") String otherAssociations, @RequestParam(value = "minMoneyRaised") float minMoneyRaised, @RequestParam(value = "maxMoneyRaised") float maxMoneyRaised, @RequestParam(value = "quantityServedPeople") int quantityServedPeople, @RequestParam(value = "city") @Valid City city, @RequestParam(value = "club") @Valid Club club, @RequestParam(value = "typeService") @Valid TypeService typeService, @RequestParam(value = "competenceArea") @Valid CompetenceArea competenceArea, @RequestParam(value = "pageNumber") int pageNumber, @RequestParam(value = "pageSize") int pageSize) {
        return new ResponseEntity(searchService.findServicesAdvanced(title, startDate, endDate, quantityParticipants, impact, duration, otherAssociations, minMoneyRaised, maxMoneyRaised, quantityServedPeople, city, club, typeService, competenceArea, pageNumber, pageSize), HttpStatus.OK);
    }
